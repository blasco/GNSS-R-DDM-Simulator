...
fig_time.colorbar(cs_time, label='C/A chips')
...
ax_line.scatter(x_sp_tds, x_sp_tds, s=70, marker=(5, 2), zorder=4)
ax_lines.scatter(x_sp_tds, y_sp_tds, s=70, marker=(5, 2), zorder=4)

ax_line.scatter(x_search, y_search, s=70, zorder=4)
ax_lines.scatter(x_search, y_search, s=70, zorder=4)
...
# Intersections
intersections = find_contour_intersection(contour_time, contour_doppler)
try:
    for i in intersections:
        ax_line.scatter(i.x, i.y, s=70, zorder=4)
        ax_lines.scatter(i.x, i.y, s=70, zorder=4)
