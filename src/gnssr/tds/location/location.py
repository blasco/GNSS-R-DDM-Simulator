...
target_delay_increment = 14.6
target_doppler_increment = -4250
...
contour_delay = ax_surface.contour(X, Y, Z_time_chip, np.arange(0,20,0.5), cmap='viridis')
...
ax_surface.scatter(x_sp_tds, x_sp_tds, s=70, marker=(5, 2), zorder=4)
...
ax_surface.scatter(x_target, y_target, s=70, zorder=4)
...
try:
    for i in intersections:
        ax_surface.scatter(i.x, i.y, s=70, zorder=4)
