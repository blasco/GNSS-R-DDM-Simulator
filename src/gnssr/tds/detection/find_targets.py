...
class target_processor_power:
    ...
    def process_ddm(self, ddm_raw):
        ...
        for i in range(1, self.n):
            ...
            self.sea_clutter_0 += ddm_i
            self.sea_clutter_0 *= 0.5 
        ...
        for i in range(1, self.n):
            ...
            self.sea_clutter = self.sea_clutter + self.tau*(ddm_i - self.sea_clutter)
