...
def simulate_ddm(sim_config):
    ...
    delay_increments_waf = list(np.linspace(
        -delay_increment_end, 
        delay_increment_end, 
        len(delay_increments_sigma)
        ))
...
def simulate_ddm_waf(sim_config):
    ...
    return ddm_matrix, waf_matrix, sigma_matrix
